...
Now that we've written [`plot_precipitation_climatology.py`]https://raw.githubusercontent.com/adyork/python-oceanography-lesson/blob/gh-pages/code/plot_precipitation_climatology.py),
