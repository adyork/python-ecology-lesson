...
To setup for this section, use this version of the `plot_precipitation_climatology.py` that has an added function to apply a mask.  This was done during the [vectorization challenge: plot_precipitation_climatology.py section](https://adyork.github.io/python-oceanography-lesson/18c-vectorisation/index.html#plot_precipitation_climatologypy).
