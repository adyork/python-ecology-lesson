...
You can download a copy of this script by right clicking this link and choosing "Save link as..." [plot_precipitation_climatology.py](https://github.com/adyork/python-oceanography-lesson/raw/gh-pages/code/plot_precipitation_climatology.py). It looks like this:
